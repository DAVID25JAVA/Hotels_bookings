...
function Footer() {
  return (
    <>
      <footer class=" max-w-8xl px-6 md:px-16 lg:px-24 xl:px-20 pt-8 w-full text-gray-200 bg-gray-900">
        <div class=" 2xl:container 2xl:mx-auto flex flex-col md:flex-row justify-between w-full gap-10 border-b border-gray-500/30 pb-6">
          <div class="md:max-w-xl">
            <img class="h-9 w-40" src="/logo.png" alt="dummyLogoDark" />
          ...
          <div class="flex-1 flex-col md:flex-row flex items-start md:justify-end gap-5 md:gap-20">
            <div>
              <h2 class="font-semibold text-[20px] mb-5 text-gray-100">
                Company
              </h2>
            ...
            <div>
              <h2 class="font-semibold text-gray-100 text-[20px] mb-5">
